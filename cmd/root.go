...
import (
	...
	"github.com/ethpandaops/ethereum-validator-metrics-exporter/pkg/exporter"
...
var rootCmd = &cobra.Command{
	Use:   "ethereum-validator-metrics-exporter",
	Short: "A tool to export the ethereum validator state",
